<template>
  <div class="container col-md-7 col-sm-12 sm-container">
    ...
    <div class="col-12 full-col-12">
      ...
      >
        <div class="list-group-item list-group-item-action">
          ...
          <span
            v-if="service.maintenance_mode"
            class="badge float-right bg-maintenance"
          >MAINTENANCE</span>
          <span
            v-else
    ...
    <div
      v-if="core.show_graphs"
      class="col-12 full-col-12"
    >
      <div
